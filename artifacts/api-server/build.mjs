...
globalThis.__dirname = __bannerPath.dirname(globalThis.__filename);
  ...
  // by the Vercel serverless function at /api/[...path].ts. Bundled
  ...
  // compiles api/[...path].ts to CommonJS, and CommonJS cannot require() an ES
  // module - an .mjs bundle here dies at runtime with:
  //
  //   Error [ERR_REQUIRE_ESM]: require() of ES Module .../app.mjs
  //   from /var/task/api/[...path].js not supported
  //
  ...
  // esbuild emits JavaScript only, but Vercel type-checks api/[...path].ts
  ...
  await writeFile(
    ...
    [
      ...
      "// app.cjs for the Vercel serverless entry at api/[...path].ts.",
